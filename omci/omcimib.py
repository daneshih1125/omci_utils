...
ME_SPEC = {
    ...
    137: ("Network Address", [
        ("Security pointer", 2, "u16", True),
        ("Address pointer", 2, "u16", True)
    ]),
    ...
    149: ("SIP Config Portal", [
        ("Configuration text table", 1, "table", False)
    ]),
    ...
    159: ("Equipment protection profile", [
        ...
        ("working slot 1,working slot 2,working slot 3,working slot 4,working slot 5,working slot 6,working slot 7,working slot 8", 8, "hex", True),
    ...
    271: ("GAL TDM profile", [
        ("Maximum GEM payload size", 2, "16", True)
    ]),
    # 9.2.6 GAL Ethernet profile
    272: ("GAL Ethernet profile", [
        ("Maximum GEM payload size", 2, "u16", True)
    ]),
    ...
    306: ("Dot1ag chassis-management info", [
        ...
        ("Management address domain 1, Management address domain 2", 50, "str", False),
    ...
    308: ("General purpose buffer", [
        ("Maximum size", 4, "u32", True),
        ("Buffer table", 1, "table", False)
    ]),
